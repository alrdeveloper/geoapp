...
class ModeloController extends AppController
{
	...
	{
		$this->view = new ModeloView("Modelo");
		$this->sql = new AppInstructionSQL("modelo");
	}
	...
	public function deleteAction($param)
	{
		...
		if (! is_array($result))
		{
			$this->redirect("/Modelo/principal");
		}
	}
	...
	public function gerenciarAction($param, $get, $post, $file)
	{
		...
		$entidade = new Modelo();
		$listEntidade = $entidade->returnModelosForSelect();		
		if (! empty($param))
		{
