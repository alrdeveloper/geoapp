...
class Frequencia extends AppEntidade implements IEntidade
{
	...
	public function returnFrequenciasForSelect() {
		$sql = "SELECT * FROM frequencia WHERE status = 1 ORDER BY nome ASC";
