...
class AreaFuncionario extends AppEntidade implements IEntidade
{
	...
	public function returnAreaFuncionariosForSelect() {
		$sql = "SELECT * FROM area_funcionario WHERE status = 1 ORDER BY nome ASC";
