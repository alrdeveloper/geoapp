...
class AreaFuncionarioView extends AppView {
    ...
    public function principal($obj, $post, $pg) {
    	$this->nav->Adicionar("Funcionários - Principal");
    	$this->assign("Nav", $this->nav->Gerar());
        
    	$this->assign("Obj", $obj);
        parent::principal($post, "AreaFuncionario", $pg);
    }
    ...
    public function gerenciar($obj, $result, $select) {
    	$this->nav->Adicionar("Funcionários - Principal", "/AreaFuncionario/principal");
    	if (empty($obj->getId())) {
        ...
        parent::gerenciar($obj, "AreaFuncionario", $result);
    }
    ...
    public function visualizar($obj) {
        ...
        parent::visualizar("AreaFuncionario");
    }
