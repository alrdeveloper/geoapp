...
class DocumentoView extends AppView {
    ...
    public function principal($obj, $post, $pg) {
    	...
    	$this->assign("Obj", $obj);
        parent::principal($post, "Documento", $pg);
    }
    ...
    public function gerenciar($obj, $result) {
    	$this->nav->Adicionar("Principal", "/Documento/principal");
    	if (empty($obj->getId())) {
        ...
        parent::gerenciar($obj, "Documento", $result);
    }
