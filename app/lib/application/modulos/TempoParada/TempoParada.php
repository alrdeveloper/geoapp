...
class TempoParada extends AppEntidade implements IEntidade
{
	...
	public function returnTempoParadasForSelect() {
		$sql = "SELECT * FROM tempo_parada WHERE status = 1 ORDER BY nome ASC";
