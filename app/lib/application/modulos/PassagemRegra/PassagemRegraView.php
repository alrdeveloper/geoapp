...
class PassagemRegraView extends AppView {
    ...
    public function principal($obj, $post, $pg) {
    	$this->nav->Adicionar("PassagemRegra - Principal");
    	$this->assign("Nav", $this->nav->Gerar());
        
    	$this->assign("Obj", $obj);
        parent::principal($post, "PassagemRegra", $pg);
    }
    ...
    public function gerenciar($obj, $result, $select) {
    	$this->nav->Adicionar("PassagemRegra - Principal", "/PassagemRegra/principal");
    	if (empty($obj->getId())) {
        ...
        parent::gerenciar($obj, "PassagemRegra", $result);
    }
    ...
    public function visualizar($obj) {
        ...
        parent::visualizar("PassagemRegra");
    }
