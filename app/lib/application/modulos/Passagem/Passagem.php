...
class Passagem extends AppEntidade implements IEntidade
{
	...
	public function returnPassagemsForSelect() {
		$sql = "SELECT * FROM passagem WHERE status = 1 ORDER BY nome ASC";
