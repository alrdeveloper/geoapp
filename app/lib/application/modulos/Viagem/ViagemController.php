...
class ViagemController extends AppController
{
	private $view, $sql;

	public function __construct()
	{
		$this->view = new ViagemView("Viagem");
		$this->sql = new AppInstructionSQL("viagem");
	}
	...
	public function deleteAction($param)
	{
		...
		if (! is_array($result))
		{
			$this->redirect("/Viagem/principal");
		}
	}
	...
	public function gerenciarAction($param, $get, $post, $file)
	{
		...
		$entidade = new Viagem();
		$listEntidade = $entidade->returnViagemsForSelect();		
		if (! empty($param))
		{
