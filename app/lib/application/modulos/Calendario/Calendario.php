...
class Calendario extends AppEntidade implements IEntidade
{
	...
	public function returnCalendariosForSelect() {
		$sql = "SELECT * FROM calendario WHERE status = 1 ORDER BY nome ASC";
