...
class DocumentoValorController extends AppController
{
	private $view, $sql;

	public function __construct()
	{
		$this->view = new DocumentoValorView("DocumentoValor");
		$this->sql = new AppInstructionSQL("documento_valor");
	}

	public function deleteAction($param)
	{
		$entidade = new DocumentoValor();
		$result = parent::deleteAction($entidade, $this->sql, $param);
		if (! is_array($result))
		{
			$this->redirect("/DocumentoValor/principal");
		}
	}
