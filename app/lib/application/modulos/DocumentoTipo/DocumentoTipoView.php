...
class DocumentoTipoView extends AppView {
    ...
    public function principal($obj, $post, $pg) {
    	...
    	$this->assign("Obj", $obj);
        parent::principal($post, "DocumentoTipo", $pg);
    }
    ...
    public function gerenciar($obj, $result) {
    	$this->nav->Adicionar("Principal", "/DocumentoTipo/principal");
    	if (empty($obj->getId())) {
        ...
        parent::gerenciar($obj, "DocumentoTipo", $result);
    }
    ...
    public function visualizar($obj) {
        ...
        parent::visualizar("DocumentoTipo");
    }
    ...
    protected function paramBySearch() {
        ...
        $param[2]["attribute"] = "documento_tipo";
