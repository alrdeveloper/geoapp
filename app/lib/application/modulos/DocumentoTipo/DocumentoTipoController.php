...
class DocumentoTipoController extends AppController
{
	private $view, $sql;

	public function __construct()
	{
		$this->view = new DocumentoTipoView("DocumentoTipo");
		$this->sql = new AppInstructionSQL("documento_tipo");
	}

	public function deleteAction($param)
	{
		$entidade = new DocumentoTipo();
		$result = parent::deleteAction($entidade, $this->sql, $param);
		if (! is_array($result))
		{
			$this->redirect("/DocumentoTipo/principal");
		}
	}
