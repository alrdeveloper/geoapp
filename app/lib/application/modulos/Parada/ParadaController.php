...
class ParadaController extends AppController
{
	private $view, $sql;

	public function __construct()
	{
		$this->view = new ParadaView("Parada");
		$this->sql = new AppInstructionSQL("parada");
	}
	...
	public function deleteAction($param)
	{
		...
		if (! is_array($result))
		{
			$this->redirect("/Parada/principal");
		}
	}
	...
	public function gerenciarAction($param, $get, $post, $file)
	{
		...
		$entidade = new Parada();
		$listEntidade = $entidade->returnParadasForSelect();		
		if (! empty($param))
		{
