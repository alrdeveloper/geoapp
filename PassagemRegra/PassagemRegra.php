...
class PassagemRegra extends AppEntidade implements IEntidade
{
	...
	public function returnPassagemRegrasForSelect() {
		$sql = "SELECT * FROM passagem_regra WHERE status = 1 ORDER BY nome ASC";
